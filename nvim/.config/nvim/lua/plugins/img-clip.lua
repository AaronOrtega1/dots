...
return {
  ...
  opts = {
    ...
    default = {
      ...
      dir_path = function()
        -- Obtén el nombre del archivo actual sin la extensión
        local current_file_name = vim.fn.expand("%:t:r")

        -- Define la ruta base donde se guardarán las imágenes
        local base_path = "../3-Resources/Assets/"

        -- Combina la ruta base con el nombre del archivo actual y el sufijo "-img"
        local full_path = base_path .. current_file_name .. "-img"
